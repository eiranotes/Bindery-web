import { createSupabaseCommunityRepository } from "../../../lib/server/community/posts.ts";
import { submitCommunityReport } from "../../../lib/server/community/reports.ts";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return jsonNoStore(result, {
      status: result.ok ? (result.code === "created" ? 201 : 200) : 400,
    });
  } catch {
